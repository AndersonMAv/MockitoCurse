...
public class FinalizarLeilaoServiceTest {
    ...
    @Test
    void deveriaFianlizarUmLeilao() {
        List<Leilao> leiloes = leiloes();

        //Definindo valores que o metodo buscarLeiloesExpirados irá retornar, simulando a chamada dele.
    ...
    @Test
    void naoDeveEnviarEmailSeEstourarException() {
        List<Leilao> leiloes = leiloes();
